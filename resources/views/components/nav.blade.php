    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16 items-center">
        ...
        <div class="hidden md:flex items-center space-x-8">
          <a href="{{ route('home') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">Home</a>
          <a href="{{ route('services') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">Services</a>
          <a href="{{ route('projects') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">Projects</a>
          <a href="{{ route('team') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">Team</a>
          <a href="{{ route('about') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">About</a>
          <a href="{{ route('contact') }}"
            class="text-base font-semibold text-gray-500 hover:text-indigo-600 transition">Contact</a>
        </div>
      ...
      <div id="mobile-menu" class="md:hidden max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
        <div class="flex flex-col text-center space-y-3 py-2">
          ...
          <a href="{{ route('services') }}"
            class="block px-3 py-2 text-base font-semibold text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md transition">Services</a>
          <a href="{{ route('projects') }}"
