<div class="bg-white text-gray-800 mt-16">
    <section class="py-16 bg-gradient-to-r from-pink-50 to-purple-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center">
            <div class="md:w-4/5 mb-10 md:mb-0">
            ...
            <div class="md:w-1/2 justify-center hidden lg:flex">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">CEO & Founder</p>
                        ...
                        <div class="flex space-x-4">
                            <a href="#" aria-label="Alex's LinkedIn profile"
                                class="text-gray-500 hover:text-pink-600 transition-colors duration-200">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Chief Technology Officer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Head of Design</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Head of Product</p>
                        <p class="text-gray-600 text-sm mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Frontend Developer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Backend Developer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Full Stack Developer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Mobile Developer</p>
                        <p class="text-gray-600 text-sm mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">UX Designer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">UI Designer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">Graphic Designer</p>
                        <p class="text-gray-600 text-sm mb-4">
                ...
                <div class="bg-white hover:cursor-pointer rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu opacity-100 animate-fade-in"
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p class="text-pink-600 mb-3">UX Researcher</p>
                        <p class="text-gray-600 text-sm mb-4">
