  <div class="flex items-center mx-30 gap-42 justify-around mb-32 mt-48">
    ...
    <ul class="flex-1 flex-col items-start justify-center space-y-4">
      ...
      <li class="flex"><i class="fa-solid fa-thumbtack rotate-45 text-purple-700 text-4xl mt-4 mr-2"><i
            class="fa-solid fa-minus text-2xl bg-white text-red rotate-90 text-pink-500 relative right-6 top-3"></i></i>
        <span class="flex-1 space-y-1">
          <h1 class="text-gray-800 text-xl font-semibold">Address</h1>
          <p class="text-gray-600 ">Moonshine St. 14/05 Light City, London</p>
        </span>
      </li>
      <li class="flex"><i class="fa-solid fa-phone text-purple-700 text-3xl mt-3 mr-2"><i
            class="fa-solid fa-wifi text-pink-500 text-sm relative right-4 bottom-4 rotate-45"></i></i>
        <span class="flex-1 space-y-1">
