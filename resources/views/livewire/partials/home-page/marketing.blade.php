  <div class = "max-w-[1200px] mx-auto">
      ...
      <div class="flex md:flex-row flex-col max-w-9xl  bg-white  rounded-xl overflow-hidden mt-12">
        ...
        <div
            class="lg:w-6/12 w-full flex-[0_0_auto] lg:px-[20px] md:px-[20px] px-[15px] max-w-full lg:ml-[8.33333333%] lg:order-2 relative mt-[30px] md:mt-[50px] flex justify-center items-center">
            <img src="imgs/happycustomer1.jpeg" alt="Happy Customer"
                class="w-full max-w-[625px] h-auto md:h-[590px] object-cover rounded-r-xl z-1">
            <!-- Happy Clients Card -->
