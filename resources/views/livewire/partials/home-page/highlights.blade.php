    <section class="mt-20 relative  max-w-[1200px] mx-auto">
        <div
            ...
            <div class="flex flex-col md:flex-row w-full">
                <div class="flex-1 flex flex-col items-center md:border-r md:border-gray-300 px-8">
                ...
                <div class="flex-1 flex flex-col items-center md:border-r md:border-gray-300 px-8">
                    ...
                    <p class="text-4xl font-bold text-gray-800">4x</p>
                    <p class="text-gray-600">Revenue Growth</p>
                </div>
                <div class="flex-1 flex flex-col items-center px-8">
                    <img src="imgs/users-alt.svg" class="h-8 w-8 mb-2" alt="Customer Satisfaction">
                    <p class="text-4xl font-bold text-gray-800">99.7%</p>
